  ...
  const experiences = [
    {
      ...
      skills: ['React.js', 'React Native', 'Node.js', 'TypeScript', 'Java', 'Firebase', 'Firestore', 'Cloud Functions', 'PostgreSQL', 'REST APIs', 'JavaScript', 'Tailwind CSS', 'Redux Toolkit', 'Express.js', 'MongoDB', 'Docker', 'Git']
    },
  ]
    ...
    <main className="w-full">
      <section className="border-b-[3px] border-black bg-white text-center">
        <div className="p-4">
          ...
          <p className="font-body-md text-body-md max-w-2xl mx-auto">
            Currently working at <a href="https://www.linkedin.com/company/reactorbee/posts/?feedView=all" target="_blank" rel="noreferrer" className="hover:underline text-[#FF5C00]">ReactorBee Private Limited</a>, designing and developing production-grade web and cross-platform applications.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white p-4 border-b-[3px] border-black">
        <h2 className="font-headline-lg text-headline-lg uppercase mb-6 text-black">CORE COMPETENCIES</h2>
